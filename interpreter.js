...
function evaluateExpression(expression) {
  return math.evaluate(preprocessExpression(expression), variables);
}
  ...
  try {
    ...
    if (matchVariable) {
      if (trimmedLine === "end") {
        ...
        if (caseValue === "_") {
          matchCases.default = removeQuotes(printStatement[1]);
        } else {
          ...
          if (type === "int") {
            ...
            matchCases[caseValue] = removeQuotes(expression);
          }
        }
      }
    }
